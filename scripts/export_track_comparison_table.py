...
ROW_SPECS: Sequence[RowSpec] = (
    ...
    RowSpec(
        ...
        matched_artifact_path="artifacts/track_c/transcender_track_c_gemma_results_matched_p1_p5.json",
        container_key="modes",
    ...
    RowSpec(
        ...
        matched_artifact_path="artifacts/track_c/transcender_track_c_gemma_selective_depth_results_matched_p1_p5.json",
        container_key="modes",
